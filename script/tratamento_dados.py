...
# =====================================================
# 8. TABELA FINAL POR DÉCADA
# =====================================================

feminicidios_decada = (
    feminicidios_fbsp.groupby("Decada")["Feminicidios_FBSP"]
    .sum()
    .reset_index()
)

conservadorismo_decada = (
    conservadorismo.groupby("Decada")["Indice_Conservadorismo"]
    .mean()
    .reset_index()
)

tabela_decada = pd.DataFrame({
    "Decada": ["1998-2009", "2010-2019", "2020-2025"]
})

tabela_decada = tabela_decada.merge(homicidios_decada, on="Decada", how="left")
tabela_decada = tabela_decada.merge(feminicidios_decada, on="Decada", how="left")
tabela_decada = tabela_decada.merge(conservadorismo_decada, on="Decada", how="left")

tabela_decada["Observacao"] = [
    "Base histórica de homicídios de mulheres. Menor presença de redes sociais.",
    "Crescimento das redes sociais e início da série de feminicídio em 2015.",
    "Período recente com feminicídios FBSP, conservadorismo Ipsos e misoginia digital."
]
...
fontes = pd.DataFrame([
    {
        "Base": "feminicidio_serie_historica.csv",
        "Tipo": "Homicídios de mulheres",
        "Periodo": "1998-2024",
        "Uso": "Base principal histórica"
    },
    {
        "Base": "FBSP - Nota Técnica Dia da Mulher 2026",
        "Tipo": "Feminicídios registrados",
        "Periodo": "2015-2025",
        "Uso": "Complemento dos anos recentes"
    },
    {
        "Base": "Ipsos/Ipec",
        "Tipo": "Conservadorismo",
        "Periodo": "2021-2025",
        "Uso": "Indicador contextual"
    },
    {
        "Base": "DataSenado",
        "Tipo": "Violência doméstica e machismo",
        "Periodo": "2013, 2019, 2023, 2025",
        "Uso": "Indicadores de percepção e prevalência"
    },
    {
        "Base": "NetLab-UFRJ / Ministério das Mulheres",
        "Tipo": "Misoginia digital",
        "Periodo": "2024-2026",
        "Uso": "Indicador contextual da década de 2020"
    }
])
...
tabela_decada.to_csv(
    os.path.join(PASTA_SAIDA, "tabela_decada_powerbi.csv"),
    index=False,
    encoding="utf-8-sig",
    sep=";",
    decimal=","
...
tabela_raca.to_csv(
    os.path.join(PASTA_SAIDA, "tabela_raca_powerbi.csv"),
    index=False,
    encoding="utf-8-sig",
    sep=";",
    decimal=","
...
tabela_local.to_csv(
    os.path.join(PASTA_SAIDA, "tabela_local_powerbi.csv"),
    index=False,
    encoding="utf-8-sig",
    sep=";",
    decimal=","
...
tabela_faixa.to_csv(
    os.path.join(PASTA_SAIDA, "tabela_faixa_etaria_powerbi.csv"),
    index=False,
    encoding="utf-8-sig",
    sep=";",
    decimal=","
...
feminicidios_fbsp.to_csv(
    os.path.join(PASTA_SAIDA, "feminicidios_fbsp_2015_2025.csv"),
    index=False,
    encoding="utf-8-sig",
    sep=";",
    decimal=","
...
conservadorismo.to_csv(
    os.path.join(PASTA_SAIDA, "conservadorismo_ipsos.csv"),
    index=False,
    encoding="utf-8-sig",
    sep=";",
    decimal=","
...
datasenado.to_csv(
    os.path.join(PASTA_SAIDA, "datasenado.csv"),
    index=False,
    encoding="utf-8-sig",
    sep=";",
    decimal=","
...
misoginia_digital.to_csv(
    os.path.join(PASTA_SAIDA, "misoginia_digital.csv"),
    index=False,
    encoding="utf-8-sig",
    sep=";",
    decimal=","
...
fontes.to_csv(
    os.path.join(PASTA_SAIDA, "fontes_utilizadas.csv"),
    index=False,
    encoding="utf-8-sig",
    sep=";",
    decimal=","
...
print("- tabela_decada_powerbi.csv")
print("- tabela_raca_powerbi.csv")
print("- tabela_local_powerbi.csv")
print("- tabela_faixa_etaria_powerbi.csv")
print("- feminicidios_fbsp_2015_2025.csv")
print("- conservadorismo_ipsos.csv")
print("- datasenado.csv")
print("- misoginia_digital.csv")
print("- fontes_utilizadas.csv")