...
-Padrões repetitivos de visualização
-Tentativas de migração para mensagens privadas
O sistema atual interpreta isso como engajamento, mas pode ser interação de risco.
